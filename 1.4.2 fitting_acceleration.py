...
# plt.savefig('Results/fitting_acceleration/fig_6f.png',bbox_inches='tight', dpi=100)
plt.show()
a_o = ha[model_t[model_t >= onset_time].index[0]]
print(f'Acceleration at the onset point: {a_o} km s^-2 atau {a_o*1000} m s^-2')
