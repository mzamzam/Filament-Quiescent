# -*- coding: utf-8 -*-
"""
Created on Wed May  8 08:40:48 2024
...
# i = round(len(data_list) -1)
i = 100
print(f'Current data: {data_list[i]}')
AIA_304 = f'Data/{ins}/{dtdt[:4]}/{dtdt[4:6]}/{data_list[i]}'
aia_map = sunpy.map.Map(AIA_304)

coords = SkyCoord(Tx=(-2400, 1200) * u.arcsec,Ty=(2000, 4000) * u.arcsec,frame=aia_map.coordinate_frame)

x_start, y_start = -1100, 2500#coordinate for the initial line at the solar surface
x_end, y_end = -2400, 3990 #coordinate for the end line 
xe_above, ye_above = -2300, 3990 #blue
xe_below, ye_below = -2500, 3990 #green

xs_above, ys_above = xs_below, ys_below = x_start, y_start

def find_angle(x1, y1, x2, y2, x3, y3, x4, y4):
# def find_angle(x_start, y_start, x_end, y_end, xs_above, ys_above, xe_above, ye_above):
...
ax.plot_coord(intensity_coords, lw=1, color='black')
